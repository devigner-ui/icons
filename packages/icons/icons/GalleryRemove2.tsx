...
const IconGalleryRemove2 = forwardRef<SVGSVGElement, IconProps>(
  function IconGalleryRemove2(
        ...
        {!fill ? (
          ...
          >
            ...
            <g opacity={duotone ? "0.4" : "1"}>
              <path
                d="m17.23 6.94 3.88-3.88"
                stroke="currentColor"
                strokeWidth={strokeWidth}
                strokeLinecap="round"
              />
              <path
                d="m21.11 6.94-3.88-3.88"
                stroke="currentColor"
                strokeWidth={strokeWidth}
                strokeLinecap="round"
              />
          ...
          >
            ...
            />
            <path
              d="M21.64 1H18.7c-1.27 0-2.03.76-2.03 2.03v2.94c0 1.27.76 2.03 2.03 2.03h2.94c1.27 0 2.03-.76 2.03-2.03V3.03c0-1.27-.76-2.03-2.03-2.03m.5 4.56c.25.25.25.66 0 .91a.67.67 0 0 1-.91 0l-1.06-1.06-1.05 1.06a.67.67 0 0 1-.91 0 .65.65 0 0 1 0-.91l1.06-1.06-1.06-1.05a.65.65 0 0 1 0-.91.65.65 0 0 1 .91 0l1.05 1.06 1.06-1.06a.65.65 0 0 1 .91 0c.25.25.25.66 0 .91L21.08 4.5z"
              fill="currentColor"
            />
          </svg>
        ) : (
...
export default IconGalleryRemove2;
