...
const IconMoneyForbidden = forwardRef<SVGSVGElement, IconProps>(
  function IconMoneyForbidden(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="m2.37 20.24.01-.02 5.5-5.5.03-.02a4 4 0 0 0-5.54 5.54"
              fill="currentColor"
            />
            <path
              d="m8.97 15.75-.02.03-5.5 5.5-.03.02q.98.68 2.25.7c1.46 0 2.73-.78 3.42-1.94a3.9 3.9 0 0 0-.12-4.31"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
          ...
          >
            ...
            />
            <path
              d="M8.97 15.75q0 .02-.02.03l-5.5 5.5-.03.02q.97.68 2.25.7c1.46 0 2.73-.78 3.42-1.94a3.9 3.9 0 0 0-.12-4.31"
              fill="currentColor"
            />
            <path
