...
const IconFileCheck = forwardRef<SVGSVGElement, IconProps>(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M10.56 15.5a.75.75 0 1 0-1.12-1l-2.1 2.37-.78-.87a.75.75 0 1 0-1.12 1l1.33 1.5a.75.75 0 0 0 1.12 0z"
              fill="currentColor"
            />
            <path
              d="M11.5 2.26v2.83c0 1.1 0 2.07.1 2.85.12.85.38 1.7 1.07 2.39s1.54.95 2.39 1.07c.78.1 1.75.1 2.85.1h4.05l.02.5H22l-.01-.56a5.3 5.3 0 0 0-.96-2.64l-.28-.36A33 33 0 0 0 18 5.5a28 28 0 0 0-2.89-2.16 8 8 0 0 0-1.82-1.04l-.5-.15c-.39-.1-.76-.13-1.29-.14z"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M14 22h-4c-3.77 0-5.66 0-6.83-1.17S2 17.77 2 14v-4c0-3.77 0-5.66 1.17-6.83S6.24 2 10.03 2q.9 0 1.5.02l-.02.24-.01 2.84c0 1.1 0 2.06.1 2.84.12.85.38 1.7 1.07 2.39s1.54.95 2.39 1.07c.78.1 1.75.1 2.85.1h4.05q.05.78.04 2.06V14c0 3.77 0 5.66-1.17 6.83S17.77 22 14 22m-3.5-7.56c.3.27.34.75.06 1.06l-2.67 3a.75.75 0 0 1-1.12 0L5.44 17a.75.75 0 1 1 1.12-1l.77.87 2.1-2.37a.75.75 0 0 1 1.07-.06"
              fill="currentColor"
            />
          </svg>
        )}
