...
const IconCartCross = forwardRef<SVGSVGElement, IconProps>(
  function IconCartCross(
      ...
      <>
        {!fill ? (
          ...
          >
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M2.08 2.75c.14-.39.57-.6.96-.46l.3.1q.93.33 1.55.61c.44.22.82.48 1.1.9.29.41.4.87.46 1.36q.03.33.04.74h10.64c1.69 0 3.2 0 3.65.58.44.57.27 1.44-.08 3.18l-.5 2.43c-.32 1.53-.47 2.3-1.03 2.74-.55.45-1.33.45-2.89.45h-5.3c-2.79 0-4.18 0-5.05-.91-.87-.92-.93-1.89-.93-4.83v-2.6c0-.74 0-1.24-.04-1.62a1.4 1.4 0 0 0-.2-.67 1 1 0 0 0-.53-.4A15 15 0 0 0 2.8 3.8l-.26-.1a.75.75 0 0 1-.46-.95"
              fill="currentColor"
            />
            <path
              d="M12.03 8.97a.75.75 0 1 0-1.06 1.06l.97.97-.97.97a.75.75 0 1 0 1.06 1.06l.97-.97.97.97a.75.75 0 1 0 1.06-1.06l-.97-.97.97-.97a.75.75 0 1 0-1.06-1.06l-.97.97z"
              fill="currentColor"
            />
            <path
              d="M7.5 18a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3"
