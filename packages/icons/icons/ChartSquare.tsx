...
const IconChartSquare = forwardRef<SVGSVGElement, IconProps>(
  function IconChartSquare(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M12 5.25c.41 0 .75.34.75.75v12a.75.75 0 0 1-1.5 0V6c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
            <path
              d="M7 8.25c.41 0 .75.34.75.75v9a.75.75 0 0 1-1.5 0V9c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
            <path
              d="M17 12.25c.41 0 .75.34.75.75v5a.75.75 0 0 1-1.5 0v-5c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
          </svg>
        ) : (
