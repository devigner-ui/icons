...
const IconMinusSquare = forwardRef<SVGSVGElement, IconProps>(
        ...
        {!fill ? (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 22c-4.71 0-7.07 0-8.54-1.46C2 19.07 2 16.7 2 12s0-7.07 1.46-8.54C4.93 2 7.3 2 12 2s7.07 0 8.54 1.46C22 4.93 22 7.3 22 12s0 7.07-1.46 8.54C19.07 22 16.7 22 12 22m3.75-10c0 .41-.34.75-.75.75H9a.75.75 0 0 1 0-1.5h6c.41 0 .75.34.75.75"
              fill="currentColor"
            />
          </svg>
        )}
