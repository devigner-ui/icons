...
const IconWidgetAdd = forwardRef<SVGSVGElement, IconProps>(
  function IconWidgetAdd(
        ...
        {!fill ? (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M17.5 2.75c.41 0 .75.34.75.75v2.25h2.25a.75.75 0 0 1 0 1.5h-2.25V9.5a.75.75 0 0 1-1.5 0V7.25H14.5a.75.75 0 0 1 0-1.5h2.25V3.5c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
            <path
