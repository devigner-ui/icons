...
const IconCloudDownload = forwardRef<SVGSVGElement, IconProps>(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 22c-1.89 0-2.83 0-3.41-.59C8 20.83 8 19.9 8 18s0-2.83.59-3.41C9.17 14 10.1 14 12 14s2.83 0 3.41.59c.59.58.59 1.52.59 3.41s0 2.83-.59 3.41C14.83 22 13.9 22 12 22m1.8-3.08-1.33 1.33a.67.67 0 0 1-.94 0l-1.33-1.33a.67.67 0 1 1 .94-.95l.2.2v-1.95a.67.67 0 0 1 1.33 0v1.95l.2-.2a.67.67 0 0 1 .93.95"
              fill="currentColor"
            />
          </svg>
        ) : (
