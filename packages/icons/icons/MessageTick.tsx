...
const IconMessageTick = forwardRef<SVGSVGElement, IconProps>(
  function IconMessageTick(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M9.67 17.5a4 4 0 0 1-1.37 3 3.97 3.97 0 0 1-6.05-.94 3.97 3.97 0 0 1 3.42-6.06 4 4 0 0 1 4 4"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeMiterlimit="10"
              strokeLinecap="round"
          ...
          >
            ...
            />
            <path
              d="M5.67 13.5a4 4 0 1 0 0 8 4 4 0 0 0 0-8m1.97 3.67-2.13 1.97a.8.8 0 0 1-.51.2.7.7 0 0 1-.53-.22l-.99-.99a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.48.48 1.6-1.48a.76.76 0 0 1 1.06.04c.28.3.26.78-.04 1.06"
              fill="currentColor"
            />
          </svg>
        ) : (
