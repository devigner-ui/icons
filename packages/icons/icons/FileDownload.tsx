...
const IconFileDownload = forwardRef<SVGSVGElement, IconProps>(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M8.5 13.5v5m0 0 2-1.87m-2 1.87-2-1.87"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeLinecap="round"
          ...
          >
            ...
            />
            <path
              d="M9.01 19.05a.75.75 0 0 1-1.02 0l-2-1.88A.75.75 0 1 1 7 16.07l.74.7V13.5a.75.75 0 0 1 1.5 0v3.27l.74-.7a.75.75 0 0 1 1.02 1.1z"
              fill="currentColor"
            />
            <path
