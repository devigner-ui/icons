...
const IconFileFavourite = forwardRef<SVGSVGElement, IconProps>(
  function IconFileFavourite(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M8.15 13.02c.38-.68.57-1.02.85-1.02s.47.34.85 1.02l.1.18c.11.2.16.29.25.35q.1.1.4.14l.19.04c.74.17 1.1.25 1.2.53.08.29-.17.58-.67 1.17l-.13.15c-.15.17-.22.25-.25.36s-.02.21 0 .43l.02.2c.08.8.11 1.18-.12 1.36-.23.17-.57.01-1.26-.3l-.18-.09c-.2-.09-.3-.13-.4-.13s-.2.04-.4.13l-.18.09c-.69.31-1.03.47-1.26.3-.23-.18-.2-.57-.12-1.35l.02-.2c.02-.23.03-.34 0-.44a1 1 0 0 0-.25-.36l-.13-.15c-.5-.59-.75-.88-.66-1.17s.45-.36 1.2-.53l.18-.04q.3-.06.4-.14c.09-.06.14-.16.25-.35z"
              stroke="currentColor"
              strokeWidth={strokeWidth}
            />
          </svg>
          ...
          >
            ...
            />
            <path
              d="m8.85 14.02.1.18c.11.2.16.29.25.35q.1.1.4.14l.19.04c.74.17 1.1.25 1.2.53.08.29-.17.58-.67 1.17l-.13.15c-.15.17-.22.25-.25.36s-.02.21 0 .43l.02.2c.08.8.11 1.18-.12 1.36-.23.17-.57.01-1.26-.3l-.18-.09c-.2-.09-.3-.13-.4-.13s-.2.04-.4.13l-.18.09c-.69.31-1.03.47-1.26.3-.23-.18-.2-.57-.12-1.35l.02-.2c.02-.23.03-.34 0-.44a1 1 0 0 0-.25-.36l-.13-.15c-.5-.59-.75-.88-.66-1.17s.45-.36 1.2-.53l.18-.04q.3-.06.4-.14c.09-.06.14-.16.25-.35l.1-.18c.38-.68.57-1.02.85-1.02s.47.34.85 1.02"
              fill="currentColor"
            />
            <path
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M14 22h-4c-3.77 0-5.66 0-6.83-1.17S2 17.77 2 14v-4c0-3.77 0-5.66 1.17-6.83S6.24 2 10.03 2q.9 0 1.5.02l-.02.24-.01 2.84c0 1.1 0 2.06.1 2.84.12.85.38 1.7 1.07 2.39s1.54.95 2.39 1.07c.78.1 1.75.1 2.85.1h4.05q.05.78.04 2.06V14c0 3.77 0 5.66-1.17 6.83S17.77 22 14 22m-4.05-8.8-.1-.18C9.47 12.34 9.28 12 9 12s-.47.34-.85 1.02l-.1.18c-.11.2-.16.29-.25.35q-.1.1-.4.14l-.19.04c-.74.17-1.1.25-1.2.53-.08.29.17.58.67 1.17l.13.15c.15.17.22.25.25.36s.02.21 0 .43l-.02.2c-.08.8-.11 1.18.12 1.36.23.17.57.01 1.26-.3l.18-.09c.2-.09.3-.13.4-.13s.2.04.4.13l.18.09c.69.31 1.03.47 1.26.3.23-.18.2-.57.12-1.35l-.02-.2a1 1 0 0 1 0-.44q.03-.13.25-.36l.13-.15c.5-.59.75-.88.66-1.17s-.45-.36-1.2-.53l-.18-.04q-.3-.06-.4-.14a1 1 0 0 1-.25-.35"
              fill="currentColor"
            />
          </svg>
        )}
