...
const IconCartLarge3 = forwardRef<SVGSVGElement, IconProps>(
  function IconCartLarge3(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M3.04 2.3a.75.75 0 0 0-.5 1.4l.26.1c.67.23 1.11.39 1.43.55.3.15.44.27.53.4s.16.31.2.67C5 5.8 5 6.3 5 7.04v2.6c0 2.94.06 3.91.93 4.83.73.77 1.85.89 3.87.9l1.53.01h4.96c1.55 0 2.33 0 2.89-.45.55-.45.7-1.21 1.02-2.74l.5-2.43c.35-1.74.52-2.6.08-3.18-.43-.55-1.83-.58-3.43-.58H6.49q0-.4-.04-.74c-.05-.5-.17-.95-.45-1.36A3 3 0 0 0 4.9 3q-.63-.29-1.56-.6z"
              fill="currentColor"
            />
            <path d="m8.15 6 1.65 9.38h1.53L9.67 6z" fill="currentColor" />
            <path d="m15.83 6-1.66 9.38h1.52L17.35 6z" fill="currentColor" />
          </svg>
        ) : (
          <svg
            ref={ref}
          ...
          >
            ...
            />
            <path
              d="M2.08 2.75c.14-.39.57-.6.96-.46l.3.1q.93.33 1.55.61c.44.22.82.48 1.1.9.29.41.4.87.46 1.36q.04.33.04.74h1.66l1.65 9.38c-2.02-.02-3.14-.14-3.87-.91-.87-.92-.93-1.89-.93-4.83v-2.6c0-.74 0-1.24-.04-1.62a1.4 1.4 0 0 0-.2-.67 1 1 0 0 0-.53-.4A15 15 0 0 0 2.8 3.8l-.26-.1a.75.75 0 0 1-.46-.95"
              fill="currentColor"
            />
            <path d="M11.33 15.38h2.84L15.83 6H9.67z" fill="currentColor" />
            <path
              d="M17.35 6c1.6 0 3 .03 3.43.58.44.57.27 1.44-.08 3.18l-.5 2.43c-.32 1.53-.47 2.3-1.02 2.74-.56.45-1.34.45-2.9.45h-.59z"
              fill="currentColor"
            />
          </svg>
        )}
