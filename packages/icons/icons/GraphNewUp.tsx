...
const IconGraphNewUp = forwardRef<SVGSVGElement, IconProps>(
  function IconGraphNewUp(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 2q2.09-.01 3.61.04a4.5 4.5 0 0 0 6.35 6.35Q22.01 9.9 22 12c0 4.71 0 7.07-1.46 8.54C19.07 22 16.7 22 12 22s-7.07 0-8.54-1.46C2 19.07 2 16.7 2 12s0-7.07 1.46-8.54C4.93 2 7.3 2 12 2m2.5 8.75a.75.75 0 0 1 0-1.5H17c.41 0 .75.34.75.75v2.5a.75.75 0 0 1-1.5 0v-.69l-2.01 2.01c-.69.69-1.8.69-2.48 0l-1.58-1.58a.25.25 0 0 0-.36 0l-2.29 2.29a.75.75 0 0 1-1.06-1.06l2.3-2.3a1.75 1.75 0 0 1 2.47 0l1.58 1.6c.1.09.26.09.36 0l2-2.02z"
              fill="currentColor"
            />
          </svg>
        )}
