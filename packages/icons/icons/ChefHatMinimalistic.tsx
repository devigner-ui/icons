...
const IconChefHatMinimalistic = forwardRef<SVGSVGElement, IconProps>(
  function IconChefHatMinimalistic(
      ...
      <>
        {!fill ? (
          ...
          >
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M2 10a5 5 0 0 1 5.74-4.95 4.5 4.5 0 0 1 8.52 0Q16.62 5 17 5a5 5 0 0 1 2 9.58V18c0 1.89 0 2.83-.59 3.41-.58.59-1.52.59-3.41.59H9c-1.89 0-2.83 0-3.41-.59C5 20.83 5 19.9 5 18v-3.42A5 5 0 0 1 2 10"
              fill="currentColor"
            />
            <path
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2 10a5 5 0 0 1 5.74-4.95 4.5 4.5 0 0 1 8.52 0Q16.62 5 17 5a5 5 0 0 1 2 9.58V18c0 1.89 0 2.83-.59 3.41-.58.59-1.52.59-3.41.59H9c-1.89 0-2.83 0-3.41-.59C5 20.83 5 19.9 5 18v-3.42A5 5 0 0 1 2 10m7 7.25a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5z"
              fill="currentColor"
            />
          </svg>
        )}
