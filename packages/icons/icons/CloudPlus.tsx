...
const IconCloudPlus = forwardRef<SVGSVGElement, IconProps>(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 22c-1.89 0-2.83 0-3.41-.59C8 20.83 8 19.9 8 18s0-2.83.59-3.41C9.17 14 10.1 14 12 14s2.83 0 3.41.59c.59.58.59 1.52.59 3.41s0 2.83-.59 3.41C14.83 22 13.9 22 12 22m.67-5.78a.67.67 0 0 0-1.34 0v1.11h-1.1a.67.67 0 0 0 0 1.34h1.1v1.1a.67.67 0 0 0 1.34 0v-1.1h1.1a.67.67 0 0 0 0-1.34h-1.1z"
              fill="currentColor"
            />
          </svg>
        ) : (
