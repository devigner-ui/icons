...
const IconMaximizeSquare3 = forwardRef<SVGSVGElement, IconProps>(
  function IconMaximizeSquare3(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12.5 7c0-.41.34-.75.75-.75H17c.41 0 .75.34.75.75v3.75a.75.75 0 0 1-1.5 0V8.81l-3.72 3.72a.75.75 0 1 1-1.06-1.06l3.72-3.72h-1.94A.75.75 0 0 1 12.5 7"
              fill="currentColor"
            />
            <path
...
export default IconMaximizeSquare3;
