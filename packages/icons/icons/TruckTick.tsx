...
const IconTruckTick = forwardRef<SVGSVGElement, IconProps>(
  function IconTruckTick(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M9.67 4.91a3.9 3.9 0 0 1-1.3 3.03A3.8 3.8 0 0 1 5.76 9 3.9 3.9 0 0 1 2.3 7.13 3.99 3.99 0 0 1 8.31 2a4 4 0 0 1 1.36 2.91"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeMiterlimit="10"
              strokeLinecap="round"
          ...
          >
            ...
            />
            <path
              d="M8.31 2a4 4 0 0 0-5.21-.07 4 4 0 0 0-.43 5.69A3.9 3.9 0 0 0 5.76 9a3.8 3.8 0 0 0 2.6-1.06q.47-.4.77-.95A4 4 0 0 0 8.31 2m-.58 2.52L5.64 6.54a.75.75 0 0 1-1.04 0l-1.01-.96a.75.75 0 0 1-.02-1.06.75.75 0 0 1 1.06-.02l.49.47 1.57-1.52a.75.75 0 0 1 1.06.02c.29.29.28.76-.02 1.05"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            ...
            />
            <path
              d="M13.75 2H6.36a3.7 3.7 0 0 0-3.69 3.69v6.38a1 1 0 0 0 1 1h9.15c1.02 0 1.85-.83 1.85-1.85v-8.3a.9.9 0 0 0-.92-.92m-3 5.07-2.1 2.02a.8.8 0 0 1-.52.21.7.7 0 0 1-.52-.21l-1-.96a.75.75 0 0 1 1.04-1.09l.48.47L9.7 5.99a.75.75 0 0 1 1.06.02c.3.3.28.77-.02 1.06"
              fill="currentColor"
            />
          </svg>
        )}
