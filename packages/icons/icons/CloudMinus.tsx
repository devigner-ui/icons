...
const IconCloudMinus = forwardRef<SVGSVGElement, IconProps>(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 22c-1.89 0-2.83 0-3.41-.59C8 20.83 8 19.9 8 18s0-2.83.59-3.41C9.17 14 10.1 14 12 14s2.83 0 3.41.59c.59.58.59 1.52.59 3.41s0 2.83-.59 3.41C14.83 22 13.9 22 12 22m-1.78-3.33h3.56a.67.67 0 0 0 0-1.34h-3.56a.67.67 0 0 0 0 1.34"
              fill="currentColor"
            />
          </svg>
        ) : (
