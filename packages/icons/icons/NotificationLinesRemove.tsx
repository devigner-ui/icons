...
const IconNotificationLinesRemove = forwardRef<SVGSVGElement, IconProps>(
  function IconNotificationLinesRemove(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M7 13.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5z"
              fill="currentColor"
            />
            <path
