...
const IconWallet2 = forwardRef<SVGSVGElement, IconProps>(function IconWallet2(
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M6.25 14.75a.75.75 0 0 0 1.5 0v-6a.75.75 0 1 0-1.5 0z"
            fill="currentColor"
          />
          <path
            fillRule="evenodd"
