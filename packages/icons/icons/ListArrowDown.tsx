...
const IconListArrowDown = forwardRef<SVGSVGElement, IconProps>(
  function IconListArrowDown(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M17.5 13.25c.41 0 .75.34.75.75v4.19l1.22-1.22a.75.75 0 1 1 1.06 1.06l-2.5 2.5c-.3.3-.77.3-1.06 0l-2.5-2.5a.75.75 0 0 1 1.06-1.06l1.22 1.22V14c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
          </svg>
        ) : (
