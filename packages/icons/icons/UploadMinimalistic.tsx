...
const IconUploadMinimalistic = forwardRef<SVGSVGElement, IconProps>(
  function IconUploadMinimalistic(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M12 16V3m0 0 4 4.38M12 3 8 7.38"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 2.25q.33 0 .55.24l4 4.38a.75.75 0 1 1-1.1 1.01l-2.7-2.95V16a.75.75 0 0 1-1.5 0V4.93l-2.7 2.95a.75.75 0 0 1-1.1-1.01l4-4.38a.8.8 0 0 1 .55-.24"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            <path
              d="M12.55 2.5a.75.75 0 0 0-1.1 0l-4 4.37a.75.75 0 0 0 1.1 1.01l2.7-2.95V16a.75.75 0 0 0 1.5 0V4.93l2.7 2.95a.75.75 0 1 0 1.1-1.01z"
              fill="currentColor"
            />
            <path
...
export default IconUploadMinimalistic;
