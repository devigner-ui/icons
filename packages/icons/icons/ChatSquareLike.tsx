...
const IconChatSquareLike = forwardRef<SVGSVGElement, IconProps>(
  function IconChatSquareLike(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              ...
              d="m10.99 14.3.45-.6zM12 8.1l-.54.53a.75.75 0 0 0 1.08 0zm1.01 6.2-.45-.6zm-1.01.51v-.75zm-.56-1.1a14 14 0 0 1-2.13-1.9q-1.04-1.18-1.06-2.1h-1.5c0 1.17.7 2.25 1.43 3.09.76.86 1.68 1.6 2.37 2.11zm-3.19-4c0-1.1.5-1.69 1-1.88.52-.19 1.35-.09 2.21.8l1.08-1.05C11.38 6.4 9.95 5.97 8.73 6.43c-1.24.46-1.98 1.72-1.98 3.29zm5.2 5.2c.69-.5 1.6-1.25 2.37-2.11.73-.84 1.43-1.92 1.43-3.09h-1.5q-.02.91-1.06 2.1c-.66.75-1.48 1.42-2.12 1.9zm3.8-5.2c0-1.56-.74-2.82-1.98-3.28-1.22-.46-2.65-.03-3.8 1.15l1.07 1.05c.86-.89 1.69-.99 2.2-.8.52.2 1.01.78 1.01 1.88zm-6.7 5.2c.39.3.83.65 1.45.65v-1.5l-.1-.03-.46-.33zm2.01-1.2-.46.32-.1.03v1.5c.62 0 1.06-.36 1.45-.65z"
              fill="currentColor"
            />
          </svg>
        ) : duotone ? (
          ...
          >
            ...
            />
            <path
              d="M10.99 14.3c-1.33-.97-3.49-2.83-3.49-4.58 0-2.68 2.48-3.68 4.5-1.61 2.02-2.07 4.5-1.07 4.5 1.6 0 1.76-2.16 3.62-3.49 4.6-.45.33-.68.5-1.01.5s-.56-.17-1.01-.5"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="m13.09 21.39.54-.92c.42-.7.63-1.06.97-1.26s.76-.2 1.61-.22a7 7 0 0 0 2.7-.37 5 5 0 0 0 2.7-2.7c.39-.93.39-2.09.39-4.42v-1c0-3.27 0-4.91-.74-6.11a5 5 0 0 0-1.65-1.65C18.41 2 16.77 2 13.5 2h-3c-3.27 0-4.91 0-6.11.74a5 5 0 0 0-1.65 1.65C2 5.59 2 7.23 2 10.5v1c0 2.33 0 3.5.38 4.41a5 5 0 0 0 2.7 2.71 7 7 0 0 0 2.71.37c.85.02 1.28.02 1.61.22s.55.55.97 1.26l.54.92c.49.81 1.7.81 2.18 0M7.5 9.72c0 1.75 2.16 3.61 3.49 4.59.45.33.68.5 1.01.5s.56-.17 1.01-.5c1.33-.98 3.49-2.84 3.49-4.6 0-2.67-2.48-3.67-4.5-1.6-2.02-2.07-4.5-1.07-4.5 1.6"
              fill="currentColor"
            />
          </svg>
        )}
...
export default IconChatSquareLike;
