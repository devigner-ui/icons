...
const IconDropper = forwardRef<SVGSVGElement, IconProps>(function IconDropper(
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M22 13.75v2.76c0 .65-.28 1.28-.76 1.72a7.8 7.8 0 0 1-10.48 0 2.3 2.3 0 0 1-.76-1.72V10c0-1.89 0-2.83.59-3.41C11.17 6 12.1 6 14 6h4c1.89 0 2.83 0 3.41.59.5.5.58 1.26.59 2.66h-4a.75.75 0 0 0 0 1.5h4v1.5h-3a.75.75 0 0 0 0 1.5z"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
        ...
        >
          <path
            d="M22 10.75v1.5h-3a.75.75 0 0 0 0 1.5h3v2.76c0 .65-.28 1.28-.76 1.72a7.8 7.8 0 0 1-4.49 2v1.02a.75.75 0 1 1-1.5 0v-1.03a7.8 7.8 0 0 1-4.49-1.99 2.3 2.3 0 0 1-.76-1.72V10c0-1.89 0-2.83.59-3.41C11.17 6 12.1 6 14 6h4c1.89 0 2.83 0 3.41.59.5.5.58 1.26.59 2.66h-4a.75.75 0 0 0 0 1.5z"
            fill="currentColor"
          />
          <path
            d="M14.3 2.1a3.8 3.8 0 0 0-2.36-.85H7.95c-1.37 0-2.47 0-3.34.12-.9.12-1.66.38-2.26.98S1.49 3.7 1.37 4.6c-.12.87-.12 1.97-.12 3.34v14.3a.75.75 0 1 0 1.5 0V8c0-1.44 0-2.44.1-3.2.1-.73.28-1.11.56-1.4.28-.27.66-.45 1.4-.55L8 2.75h3.93q.8 0 1.41.51l.03.03.09.07q.81.65 1.79.79V6h1.5V4.07c.61-.15 1.2-.47 1.68-.94l.07-.07.53-.53a.75.75 0 0 0-1.06-1.06l-.52.52-.07.07q-.29.27-.63.43V2a.75.75 0 0 0-1.5 0v.62q-.46-.12-.85-.43l-.07-.06z"
