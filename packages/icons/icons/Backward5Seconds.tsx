...
const IconBackward5Seconds = forwardRef<SVGSVGElement, IconProps>(
  function IconBackward5Seconds(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            <path
              opacity={duotone ? "0.4" : "1"}
              d="m12.67 3.48-.24.01.82-1.02a.74.74 0 0 0-.12-1.05.75.75 0 0 0-1.05.12L10.1 4.01l-.02.04-.07.14-.05.13-.01.14v.2l.04.09.06.14.09.11.07.08.05.03.08.05.17.06.09.02.08.01.07-.02h.09a8.15 8.15 0 1 1-6.33 7.92c0-1.74.57-3.42 1.65-4.86a.75.75 0 0 0-1.2-.9 9.5 9.5 0 0 0-1.95 5.76 9.65 9.65 0 1 0 9.66-9.67"
              fill="currentColor"
            />
          </svg>
        ) : (
...
export default IconBackward5Seconds;
