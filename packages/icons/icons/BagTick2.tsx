...
const IconBagTick2 = forwardRef<SVGSVGElement, IconProps>(function IconBagTick2(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="m11.11 15 .65.65c.19.19.5.2.69.01l1.78-1.64"
            stroke="currentColor"
            strokeWidth={strokeWidth}
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        >
          ...
          />
          <path
            d="M12.1 16.64a.7.7 0 0 1-.53-.22l-.99-.99a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.48.48 1.6-1.48a.76.76 0 0 1 1.06.04c.28.3.26.78-.04 1.06l-2.13 1.97a.8.8 0 0 1-.51.2"
            fill="currentColor"
          />
        </svg>
      ) : (
