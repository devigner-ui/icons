...
const IconHamburgerMenu = forwardRef<SVGSVGElement, IconProps>(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M18.75 12c0 .41-.34.75-.75.75H6a.75.75 0 0 1 0-1.5h12c.41 0 .75.34.75.75"
              fill="currentColor"
            />
            <path
              d="M18.75 16c0 .41-.34.75-.75.75H6a.75.75 0 0 1 0-1.5h12c.41 0 .75.34.75.75"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M3.46 20.54C4.93 22 7.3 22 12 22s7.07 0 8.54-1.46C22 19.07 22 16.7 22 12s0-7.07-1.46-8.54C19.07 2 16.7 2 12 2S4.93 2 3.46 3.46C2 4.93 2 7.3 2 12s0 7.07 1.46 8.54M18.75 16c0 .41-.34.75-.75.75H6a.75.75 0 0 1 0-1.5h12c.41 0 .75.34.75.75M18 12.75a.75.75 0 0 0 0-1.5H6a.75.75 0 0 0 0 1.5zM18.75 8c0 .41-.34.75-.75.75H6a.75.75 0 0 1 0-1.5h12c.41 0 .75.34.75.75"
              fill="currentColor"
            />
          </svg>
        )}
