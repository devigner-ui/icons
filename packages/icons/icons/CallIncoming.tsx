...
const IconCallIncoming = forwardRef<SVGSVGElement, IconProps>(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M21.67 8.55h-4.8a.76.76 0 0 1-.75-.75V3c0-.41.34-.75.75-.75s.75.34.75.75v4.05h4.05c.41 0 .75.34.75.75s-.34.75-.75.75"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
