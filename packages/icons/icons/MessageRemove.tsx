...
const IconMessageRemove = forwardRef<SVGSVGElement, IconProps>(
  function IconMessageRemove(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M9.67 17.5q0 .48-.12.93-.14.61-.46 1.13a3.97 3.97 0 0 1-6.84 0 4 4 0 1 1 7.42-2.06"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeMiterlimit="10"
              strokeLinecap="round"
          ...
          >
            ...
            />
            <path
              d="M8.64 14.83a4 4 0 1 0-5.94 5.34 4 4 0 0 0 5.94-5.34m-1.37 4.25a.7.7 0 0 1-.53.22.7.7 0 0 1-.53-.22l-.53-.53-.55.55a.7.7 0 0 1-.53.22.7.7 0 0 1-.53-.22.75.75 0 0 1 0-1.06l.55-.55-.53-.53a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.53.53.5-.5a.75.75 0 0 1 1.06 0c.29.29.29.77 0 1.06l-.5.5.53.53c.29.29.29.76 0 1.06"
              fill="currentColor"
            />
          </svg>
        ) : (
