...
const IconChatSquareCall = forwardRef<SVGSVGElement, IconProps>(
  function IconChatSquareCall(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M12 6.25c.41 0 .75.34.75.75v8a.75.75 0 1 1-1.5 0V7c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
            <path
              d="M8 8.25c.41 0 .75.34.75.75v4a.75.75 0 1 1-1.5 0V9c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
            <path
              d="M16 8.25c.41 0 .75.34.75.75v4a.75.75 0 1 1-1.5 0V9c0-.41.34-.75.75-.75"
              fill="currentColor"
            />
          </svg>
        ) : (
...
export default IconChatSquareCall;
