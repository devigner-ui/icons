...
const IconBoxTime = forwardRef<SVGSVGElement, IconProps>(function IconBoxTime(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            d="M23.67 18a4 4 0 0 1-4 4 4 4 0 1 1 4-4"
            stroke="currentColor"
            strokeWidth={strokeWidth}
            strokeMiterlimit="10"
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M22.65 15.65a4.46 4.46 0 0 0-6.29-.66 4.5 4.5 0 0 0-1.69 3.51c0 1.41.64 2.66 1.65 3.48a4.45 4.45 0 0 0 5.82-.1 4.5 4.5 0 0 0 .51-6.23m-2.45 3.13c0 .26-.14.51-.36.64l-1.4.84a.75.75 0 0 1-1.03-.25.75.75 0 0 1 .25-1.03l1.04-.62V17.1c0-.41.34-.75.75-.75s.75.34.75.75z"
            fill="currentColor"
          />
        </svg>
      )}
