...
const IconChatDots = forwardRef<SVGSVGElement, IconProps>(function IconChatDots(
      ...
      {!fill ? (
        ...
        >
          ...
          <g opacity={duotone ? "0.4" : "1"}>
            <path d="M9 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0" fill="currentColor" />
            <path d="M13 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0" fill="currentColor" />
            <path d="M17 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0" fill="currentColor" />
          </g>
        </svg>
      ) : duotone ? (
        <svg
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="m13.09 21.39.54-.92c.42-.7.63-1.06.97-1.26s.76-.2 1.61-.22a7 7 0 0 0 2.7-.37 5 5 0 0 0 2.7-2.7c.39-.93.39-2.09.39-4.42v-1c0-3.27 0-4.91-.74-6.11a5 5 0 0 0-1.65-1.65C18.41 2 16.77 2 13.5 2h-3c-3.27 0-4.91 0-6.11.74a5 5 0 0 0-1.65 1.65C2 5.59 2 7.23 2 10.5v1c0 2.33 0 3.5.38 4.41a5 5 0 0 0 2.7 2.71 7 7 0 0 0 2.71.37c.85.02 1.28.02 1.61.22s.55.55.97 1.26l.54.92c.49.81 1.7.81 2.18 0M16 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-3-1a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-5 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2"
            fill="currentColor"
          />
        </svg>
      )}
