...
const IconSidebarMinimalistic = forwardRef<SVGSVGElement, IconProps>(
  function IconSidebarMinimalistic(
        ...
        {!fill ? (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M3.17 4.17C2 5.34 2 7.23 2 11v2c0 3.77 0 5.66 1.17 6.83S6.23 21 10 21h4.25V3H10C6.23 3 4.34 3 3.17 4.17m12.58-1.16v17.98c2.64-.02 4.1-.19 5.08-1.16C22 18.66 22 16.77 22 13v-2c0-3.77 0-5.66-1.17-6.83-.98-.97-2.44-1.14-5.08-1.16"
              fill="currentColor"
            />
          </svg>
        )}
