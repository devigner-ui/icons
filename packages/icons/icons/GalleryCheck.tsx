...
const IconGalleryCheck = forwardRef<SVGSVGElement, IconProps>(
  function IconGalleryCheck(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M17.5 11c-2.12 0-3.18 0-3.84-.66S13 8.62 13 6.5s0-3.18.66-3.84S15.38 2 17.5 2s3.18 0 3.84.66S22 4.38 22 6.5s0 3.18-.66 3.84-1.72.66-3.84.66m2.53-5.47a.75.75 0 0 0-1.06-1.06L16.5 6.94l-.47-.47a.75.75 0 1 0-1.06 1.06l1 1c.3.3.77.3 1.06 0z"
              fill="currentColor"
            />
          </svg>
        ) : (
...
export default IconGalleryCheck;
