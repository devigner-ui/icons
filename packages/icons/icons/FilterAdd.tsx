...
const IconFilterAdd = forwardRef<SVGSVGElement, IconProps>(
  function IconFilterAdd(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M17.55 10a4.75 4.75 0 1 0 0 9.5 4.75 4.75 0 0 0 0-9.5m1.78 5.48H18.3v1.07c0 .41-.34.75-.75.75a.76.76 0 0 1-.75-.75v-1.07h-1.02a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h1.02V13c0-.41.34-.75.75-.75s.75.34.75.75v.98h1.03c.41 0 .75.34.75.75s-.34.75-.75.75"
              fill="currentColor"
            />
          </svg>
        ) : (
