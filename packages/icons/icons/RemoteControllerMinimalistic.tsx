...
const IconRemoteControllerMinimalistic = forwardRef<SVGSVGElement, IconProps>(
  function IconRemoteControllerMinimalistic(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M15 11a3 3 0 1 1-6 0 3 3 0 0 1 6 0"
              stroke="currentColor"
              strokeWidth={strokeWidth}
            />
            <circle cx="12" cy="5.00012" r="1" fill="currentColor" />
            <circle cx="12" cy="17.0001" r="1" fill="currentColor" />
          </svg>
        ) : duotone ? (
          <svg
            ref={ref}
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5.67 3.78C5 4.78 5 6.19 5 9v6c0 2.8 0 4.21.67 5.22a4 4 0 0 0 1.1 1.1C7.8 22 9.2 22 12 22s4.21 0 5.22-.67a4 4 0 0 0 1.1-1.1C19 19.2 19 17.8 19 15V9c0-2.8 0-4.21-.67-5.22a4 4 0 0 0-1.1-1.1C16.2 2 14.8 2 12 2s-4.21 0-5.22.67a4 4 0 0 0-1.1 1.1M12 7.25a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5M13 5a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-1 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2"
              fill="currentColor"
            />
          </svg>
        )}
...
export default IconRemoteControllerMinimalistic;
