...
const IconGraph = forwardRef<SVGSVGElement, IconProps>(function IconGraph(
      ...
      {!fill ? (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M3.46 3.46C2 4.93 2 7.3 2 12s0 7.07 1.46 8.54C4.93 22 7.3 22 12 22s7.07 0 8.54-1.46C22 19.07 22 16.7 22 12s0-7.07-1.46-8.54C19.07 2 16.7 2 12 2S4.93 2 3.46 3.46m14.12 7.02a.75.75 0 0 0-1.16-.96l-1.8 2.16q-.52.64-.78.88l-.16.12h-.02l-.17-.12a10 10 0 0 1-.78-.88l-.3-.35q-.48-.61-.9-1c-.3-.28-.68-.52-1.18-.52s-.88.24-1.18.52q-.4.39-.9 1l-1.83 2.19a.75.75 0 1 0 1.16.96l1.8-2.16q.52-.64.78-.88l.16-.12h.02q.04 0 .17.12c.19.17.41.44.78.88l.3.35q.48.61.9 1c.3.28.68.52 1.18.52s.88-.24 1.18-.52q.4-.39.9-1z"
            fill="currentColor"
          />
        </svg>
      )}
