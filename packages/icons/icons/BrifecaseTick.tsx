...
const IconBrifecaseTick = forwardRef<SVGSVGElement, IconProps>(
  function IconBrifecaseTick(
        ...
        {!fill ? (
          ...
          >
            <path
              ...
              d="m11.11 14.3.65.65c.19.19.5.19.69.01l1.78-1.64"
              stroke="currentColor"
          ...
          >
            ...
            />
            <path
              d="M12.1 16.03a.7.7 0 0 1-.53-.22l-.99-.98a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.48.48 1.61-1.48a.76.76 0 0 1 1.06.04c.28.3.26.78-.04 1.06l-2.13 1.97a1 1 0 0 1-.52.19"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            <path
              d="M21.76 6.98c-.85-.94-2.26-1.41-4.33-1.41h-.24v-.04c0-1.68 0-3.76-3.76-3.76h-1.52c-3.76 0-3.76 2.08-3.76 3.76v.04h-.24q-3.09 0-4.33 1.41c-.99 1.11-.96 2.58-.86 3.59l.01.07.07.8q.03.25.23.38.43.3.87.54l.44.25q1.7.93 3.58 1.45a4.75 4.75 0 0 0 9.5-.06v-.04q1.9-.57 3.6-1.57l.15-.09c.4-.21.8-.5 1.18-.76a.5.5 0 0 0 .2-.35l.07-.61.02-.18c.08-1 .06-2.38-.88-3.42M9.58 5.53c0-1.7 0-2.34 2.33-2.34h1.52c2.33 0 2.33.64 2.33 2.34v.04H9.58zm3.09 11.72a3.25 3.25 0 1 1 3.23-2.91v.01a3.26 3.26 0 0 1-3.23 2.9"
              fill="currentColor"
            />
            <path
              d="M12.1 16.03a.7.7 0 0 1-.53-.22l-.99-.98a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.48.48 1.61-1.48a.76.76 0 0 1 1.06.04c.28.3.26.78-.04 1.06l-2.13 1.97a1 1 0 0 1-.52.19"
