...
const IconCallMinus = forwardRef<SVGSVGElement, IconProps>(
  function IconCallMinus(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M21.17 6.75h-5a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h5c.41 0 .75.34.75.75s-.34.75-.75.75"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
