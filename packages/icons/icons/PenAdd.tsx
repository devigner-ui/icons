...
const IconPenAdd = forwardRef<SVGSVGElement, IconProps>(function IconPenAdd(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M7.17 2c-1.06 0-2.04.37-2.81.99a4.45 4.45 0 0 0-1.04 5.83 4.47 4.47 0 0 0 6.81 1.06A4.3 4.3 0 0 0 11.5 7.7q.17-.58.17-1.2A4.5 4.5 0 0 0 7.17 2m1.66 5.25h-.89v.93c0 .41-.34.75-.75.75a.76.76 0 0 1-.75-.75v-.93h-.97a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h.97v-.93c0-.41.34-.75.75-.75s.75.34.75.75v.93h.89a.75.75 0 1 1 0 1.5"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            d="M7.17 2c-1.06 0-2.04.37-2.81.99a4.45 4.45 0 0 0-1.04 5.83 4.47 4.47 0 0 0 6.81 1.06A4.3 4.3 0 0 0 11.5 7.7q.17-.58.17-1.2A4.5 4.5 0 0 0 7.17 2m1.66 5.25h-.89v.93a.75.75 0 1 1-1.5 0v-.93h-.97a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h.97v-.93a.75.75 0 1 1 1.5 0v.93h.89a.75.75 0 1 1 0 1.5"
            fill="currentColor"
          />
          <path
