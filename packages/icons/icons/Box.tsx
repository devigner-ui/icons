...
const IconBox = forwardRef<SVGSVGElement, IconProps>(function IconBox(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="m6.32 4.48.1-.05 1.5-.78 9.1 5 4.02-2a3 3 0 0 1 .7 1.31l-3.99 2V13a.75.75 0 0 1-1.5 0v-2.29l-3.5 1.75v9.44a3 3 0 0 1-1.5 0v-9.44l-9-4.5a3.4 3.4 0 0 1 .71-1.32L12 11.16l3.39-1.7z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            d="m17.58 4.43-2-1.05C13.82 2.46 12.94 2 12 2s-1.82.46-3.58 1.38l-.32.17 8.92 5.1 4.02-2c-.65-.74-1.69-1.29-3.46-2.22"
            fill="currentColor"
          />
          <path
            d="m21.75 7.96-4 2V13a.75.75 0 0 1-1.5 0v-2.29l-3.5 1.75v9.44c.72-.17 1.53-.6 2.83-1.28l2-1.05c2.15-1.13 3.23-1.7 3.82-2.71.6-1.01.6-2.28.6-4.8v-.12c0-1.9 0-3.07-.25-3.98"
            fill="currentColor"
          />
          <path
          ...
          />
          <path
            d="M2.96 6.64 12 11.16l3.41-1.7-8.89-5.08-.1.05c-1.77.93-2.81 1.48-3.46 2.21"
            fill="currentColor"
          />
        </svg>
      )}
