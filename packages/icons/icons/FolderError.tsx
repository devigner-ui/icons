...
const IconFolderError = forwardRef<SVGSVGElement, IconProps>(
  function IconFolderError(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M9.97 11.47c.3-.3.77-.3 1.06 0l.97.97.97-.97a.75.75 0 1 1 1.06 1.06l-.97.97.97.97a.75.75 0 0 1-1.06 1.06l-.97-.97-.97.97a.75.75 0 0 1-1.06-1.06l.97-.97-.97-.97a.75.75 0 0 1 0-1.06"
              fill="currentColor"
            />
          </svg>
        ) : (
