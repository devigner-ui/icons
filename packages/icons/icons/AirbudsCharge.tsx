...
const IconAirbudsCharge = forwardRef<SVGSVGElement, IconProps>(
  function IconAirbudsCharge(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M18.42 15.88c.34.23.43.7.2 1.04l-.22.33h.6a.75.75 0 0 1 .62 1.17l-1 1.5a.75.75 0 1 1-1.24-.84l.22-.33H17a.75.75 0 0 1-.62-1.17l1-1.5a.75.75 0 0 1 1.04-.2"
              fill="currentColor"
            />
            <path
              fillRule="evenodd"
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M18 22a4 4 0 1 0 0-8 4 4 0 0 0 0 8m.42-6.12c.34.23.43.7.2 1.04l-.22.33h.6a.75.75 0 0 1 .62 1.17l-1 1.5a.75.75 0 1 1-1.24-.84l.22-.33H17a.75.75 0 0 1-.62-1.17l1-1.5a.75.75 0 0 1 1.04-.2"
              fill="currentColor"
            />
            <path
              fillRule="evenodd"
