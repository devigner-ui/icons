...
const IconCallAdd = forwardRef<SVGSVGElement, IconProps>(function IconCallAdd(
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M21.17 5.25h-1.75V3.5a.76.76 0 0 0-.75-.75.76.76 0 0 0-.75.75v1.75h-1.75a.76.76 0 0 0-.75.75c0 .41.34.75.75.75h1.75V8.5c0 .41.34.75.75.75s.75-.34.75-.75V6.75h1.75c.41 0 .75-.34.75-.75a.76.76 0 0 0-.75-.75"
            fill="currentColor"
          />
          <path
