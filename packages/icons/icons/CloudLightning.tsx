...
const IconCloudLightning = forwardRef<SVGSVGElement, IconProps>(
  function IconCloudLightning(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              ...
              d="M9.9 19.16h1v2.33c0 .34.43.51.65.25L14 18.95c.3-.34.17-.62-.28-.62h-1V16c0-.34-.43-.51-.65-.25l-2.45 2.79c-.3.34-.17.62.28.62"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeMiterlimit="10"
              strokeLinecap="round"
          ...
          >
            ...
            />
            <path
              d="M14.14 14.39H11.2c-1.27 0-2.03.76-2.03 2.03v2.94c0 1.27.76 2.03 2.03 2.03h2.94c1.27 0 2.03-.76 2.03-2.03v-2.94c0-1.27-.76-2.03-2.03-2.03m.2 3.66-1.67 1.9-.2.23c-.27.31-.5.23-.5-.19v-1.78h-.76c-.35 0-.44-.21-.21-.47l1.67-1.9.2-.23c.27-.31.5-.23.5.19v1.78h.76c.35-.01.44.21.21.47"
              fill="currentColor"
            />
          </svg>
        ) : (
