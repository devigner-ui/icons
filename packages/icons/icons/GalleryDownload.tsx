...
const IconGalleryDownload = forwardRef<SVGSVGElement, IconProps>(
  function IconGalleryDownload(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M17.5 2c-2.12 0-3.18 0-3.84.66S13 4.38 13 6.5s0 3.18.66 3.84 1.72.66 3.84.66 3.18 0 3.84-.66S22 8.62 22 6.5s0-3.18-.66-3.84S19.62 2 17.5 2m2.03 5.53-1.5 1.5c-.3.3-.77.3-1.06 0l-1.5-1.5a.75.75 0 0 1 1.06-1.06l.22.22V4.5a.75.75 0 0 1 1.5 0v2.19l.22-.22a.75.75 0 1 1 1.06 1.06"
              fill="currentColor"
            />
          </svg>
        ) : (
