...
const IconGamepadCharge = forwardRef<SVGSVGElement, IconProps>(
  function IconGamepadCharge(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M12.75 18.97a1 1 0 0 0 .75-.97v-.73q-.01-.25-.26-.36a4 4 0 0 0-2.48 0 .4.4 0 0 0-.26.36V18a1 1 0 0 0 .75.97v3.28a.75.75 0 1 0 1.5 0z"
              fill="currentColor"
            />
            <g opacity={duotone ? "0.4" : "1"}>
              <path
          ...
          >
            <path
              d="M12.75 19.97a1 1 0 0 0 .75-.97v-.73q-.01-.25-.26-.36a4 4 0 0 0-2.48 0 .4.4 0 0 0-.26.36V19a1 1 0 0 0 .75.97v3.28a.75.75 0 1 0 1.5 0z"
              fill="currentColor"
            />
            <path
              fillRule="evenodd"
