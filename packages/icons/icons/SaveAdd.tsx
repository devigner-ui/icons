...
const IconSaveAdd = forwardRef<SVGSVGElement, IconProps>(function IconSaveAdd(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M11.67 11.25h-1.25V10a.76.76 0 0 0-.75-.75.76.76 0 0 0-.75.75v1.25H7.67a.76.76 0 0 0-.75.75c0 .41.34.75.75.75h1.25V14c0 .41.34.75.75.75s.75-.34.75-.75v-1.25h1.25c.41 0 .75-.34.75-.75a.76.76 0 0 0-.75-.75"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          ...
          />
          <path
            d="M13.56 5.88H5.78a3.1 3.1 0 0 0-3.11 3.11v11.36c0 1.45 1.04 2.06 2.31 1.36l3.93-2.19c.42-.23 1.1-.23 1.52 0l3.93 2.19c1.27.7 2.31.09 2.31-1.36V8.99c0-1.71-1.4-3.11-3.11-3.11m-1.89 6.87h-1.25V14c0 .41-.34.75-.75.75a.76.76 0 0 1-.75-.75v-1.25H7.67a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h1.25V10c0-.41.34-.75.75-.75s.75.34.75.75v1.25h1.25c.41 0 .75.34.75.75s-.34.75-.75.75"
            fill="currentColor"
          />
        </svg>
      )}
