...
const IconLockUnlocked = forwardRef<SVGSVGElement, IconProps>(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M6.75 8a5.25 5.25 0 0 1 10.33-1.31.75.75 0 0 0 1.46-.38A6.75 6.75 0 0 0 5.25 8v2.06c-1.11.08-1.84.29-2.37.82C2 11.76 2 13.18 2 16s0 4.24.88 5.12S5.18 22 8 22h8c2.83 0 4.24 0 5.12-.88S22 18.82 22 16s0-4.24-.88-5.12S18.82 10 16 10H6.75z"
              fill="currentColor"
            />
          </svg>
        )}
