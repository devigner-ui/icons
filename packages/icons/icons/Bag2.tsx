...
const IconBag2 = forwardRef<SVGSVGElement, IconProps>(function IconBag2(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M8.26 10.88a.75.75 0 1 1 1.48.24l-1 6a.75.75 0 1 1-1.48-.24z"
            fill="currentColor"
          />
          <path
            d="M14.88 10.26c.4-.07.8.2.86.62l1 6a.75.75 0 0 1-1.48.24l-1-6c-.07-.4.2-.8.62-.86"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8.25 6.02V5a3.75 3.75 0 1 1 7.5 0v1.02c1.29.03 2.07.17 2.68.67.83.7 1.05 1.86 1.49 4.2l.75 4c.61 3.3.92 4.94.02 6.03S18.12 22 14.77 22H9.23c-3.35 0-5.02 0-5.92-1.08-.9-1.09-.6-2.73.02-6.03l.75-4c.44-2.34.66-3.5 1.5-4.2.6-.5 1.38-.64 2.67-.67M9.75 5a2.25 2.25 0 0 1 4.5 0v1h-4.5zm5.99 5.88a.75.75 0 1 0-1.48.24l1 6a.75.75 0 1 0 1.48-.24zm-6.62-.62c-.4-.07-.8.2-.86.62l-1 6a.75.75 0 1 0 1.48.24l1-6c.07-.4-.2-.8-.62-.86"
            fill="currentColor"
          />
        </svg>
      )}
