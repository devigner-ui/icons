...
const IconClipboardCheck = forwardRef<SVGSVGElement, IconProps>(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M15.55 10.49c.28.3.26.78-.04 1.06l-4.28 4a.75.75 0 0 1-1.03 0l-1.71-1.6a.75.75 0 0 1 1.02-1.1l1.2 1.12 3.78-3.52a.75.75 0 0 1 1.06.04"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M6.5 4.04c-1.26.07-2.05.27-2.62.84C3 5.76 3 7.17 3 10v6c0 2.83 0 4.24.88 5.12S6.18 22 9 22h6c2.83 0 4.24 0 5.12-.88S21 18.82 21 16v-6c0-2.83 0-4.24-.88-5.12-.57-.57-1.36-.77-2.62-.84v.46a3 3 0 0 1-3 3h-5a3 3 0 0 1-3-3zm9.01 8.5a.75.75 0 1 0-1.02-1.09l-3.78 3.52-1.2-1.12a.75.75 0 1 0-1.02 1.1l1.71 1.6c.3.27.74.27 1.03 0z"
              fill="currentColor"
            />
          </svg>
        )}
