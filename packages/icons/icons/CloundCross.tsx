...
const IconCloundCross = forwardRef<SVGSVGElement, IconProps>(
  function IconCloundCross(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 22c-1.89 0-2.83 0-3.41-.59C8 20.83 8 19.9 8 18s0-2.83.59-3.41C9.17 14 10.1 14 12 14s2.83 0 3.41.59c.59.58.59 1.52.59 3.41s0 2.83-.59 3.41C14.83 22 13.9 22 12 22m-1.3-6.25a.67.67 0 0 0-.95.94l1.3 1.31-1.3 1.3a.67.67 0 0 0 .94.95l1.31-1.3 1.3 1.3a.67.67 0 0 0 .95-.94L12.95 18l1.3-1.3a.67.67 0 0 0-.94-.95L12 17.05z"
              fill="currentColor"
            />
          </svg>
        ) : (
