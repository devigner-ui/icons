...
const IconCalendarMark = forwardRef<SVGSVGElement, IconProps>(
  function IconCalendarMark(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M18 16.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M22 12v2c0 3.77 0 5.66-1.17 6.83S17.77 22 14 22h-4c-3.77 0-5.66 0-6.83-1.17S2 17.77 2 14v-2l.01-2.25H22zm-5.5 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"
              fill="currentColor"
            />
          </svg>
        )}
...
export default IconCalendarMark;
