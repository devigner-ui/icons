...
const IconCloudMinus2 = forwardRef<SVGSVGElement, IconProps>(
  function IconCloudMinus2(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M14.14 14.39H11.2c-1.27 0-2.03.76-2.03 2.03v2.94c0 1.27.76 2.03 2.03 2.03h2.94c1.27 0 2.03-.76 2.03-2.03v-2.94c0-1.27-.76-2.03-2.03-2.03m.24 4.07h-3.41a.65.65 0 0 1-.65-.65c0-.35.29-.64.65-.64h3.42c.35 0 .64.29.64.64a.66.66 0 0 1-.65.65"
              fill="currentColor"
            />
          </svg>
        ) : (
...
export default IconCloudMinus2;
