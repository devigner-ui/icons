...
const IconClipboardTick = forwardRef<SVGSVGElement, IconProps>(
  function IconClipboardTick(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M11.48 16.95a.7.7 0 0 1-.53-.22l-1.5-1.5a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.97.97 3.47-3.47a.75.75 0 0 1 1.06 0c.29.29.29.77 0 1.06l-4 4a.7.7 0 0 1-.53.22"
              fill="currentColor"
            />
          </svg>
        ) : (
