...
const IconShopRemove = forwardRef<SVGSVGElement, IconProps>(
  function IconShopRemove(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M8.6 16.28q-.15-.17-.33-.31a3.9 3.9 0 0 0-4.56-.45q-.29.15-.54.36a3.97 3.97 0 0 0-.6 5.63l.07.08a3.94 3.94 0 0 0 5.76.31q.4-.35.69-.84.57-.92.58-2.06c0-1.05-.41-2-1.07-2.72m-1.43 3.45H4.18a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h2.99c.41 0 .75.34.75.75s-.34.75-.75.75"
              fill="currentColor"
            />
            <path
          ...
          >
            ...
            />
            <path
              d="m22.65 8.59-.28-2.66c-.4-2.9-1.72-4.08-4.53-4.08H7.49c-2.82 0-4.13 1.18-4.54 4.11L2.69 8.6a3.85 3.85 0 0 0 3.89 4.3c1.21 0 2.37-.61 3.11-1.58a3.6 3.6 0 0 0 3 1.58c1.24 0 2.33-.58 2.99-1.54a4 4 0 0 0 3.08 1.54 3.88 3.88 0 0 0 3.89-4.31m-8.48-.86h-3a.75.75 0 1 1 0-1.5h3a.75.75 0 1 1 0 1.5"
              fill="currentColor"
            />
          </svg>
        )}
