...
const IconFileLeft = forwardRef<SVGSVGElement, IconProps>(function IconFileLeft(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="M11 16H6m0 0 1.88-2M6 16l1.88 2"
            stroke="currentColor"
            strokeWidth={strokeWidth}
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M5.45 15.49a.75.75 0 0 0 0 1.02l1.88 2a.75.75 0 1 0 1.1-1.02l-.7-.74H11a.75.75 0 1 0 0-1.5H7.73l.7-.74a.75.75 0 1 0-1.1-1.02z"
            fill="currentColor"
          />
          <path
