...
const IconBrifecaseTimer = forwardRef<SVGSVGElement, IconProps>(
  function IconBrifecaseTimer(
        ...
        {!fill ? (
          ...
          >
            <path
              ...
              d="M12.92 12.95v.93c0 .35-.18.68-.49.86l-.76.46"
              stroke="currentColor"
          ...
          >
            <path
              d="M11.8 15.88a.8.8 0 0 1-.64-.36.75.75 0 0 1 .26-1.03l.89-.53v-1.08c0-.41.34-.75.75-.75s.75.34.75.75v1.5c0 .26-.14.51-.36.64l-1.25.75a1 1 0 0 1-.4.11"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
          ...
          >
            ...
            />
            <path
              d="M21.71 13.73c.25-.14.57.06.55.35l-.36 3.88c-.21 2-1.03 4.04-5.43 4.04H8.85c-4.4 0-5.22-2.04-5.42-4.03l-.35-3.7c-.02-.3.28-.48.54-.35q1.17.65 2.42 1.11a1 1 0 0 1 .62.69 6.25 6.25 0 0 0 12.05-.14 1 1 0 0 1 .61-.7q1.26-.5 2.39-1.15"
              fill="currentColor"
            />
          </svg>
        )}
