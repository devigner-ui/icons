...
const IconCodeFile = forwardRef<SVGSVGElement, IconProps>(function IconCodeFile(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          <path
            opacity={duotone ? "0.4" : "1"}
            d="m7 14-1 1 1 1m4.5 0 1 1-1 1M10 14l-1.5 4"
            stroke="currentColor"
            strokeWidth={strokeWidth}
            strokeLinecap="round"
        ...
        >
          ...
          />
          <path
            d="M10.7 14.26a.75.75 0 1 0-1.4-.52l-1.5 4a.75.75 0 0 0 1.4.52z"
            fill="currentColor"
          />
          <path
            d="M7.53 14.53a.75.75 0 0 0-1.06-1.06l-1 1c-.3.3-.3.77 0 1.06l1 1a.75.75 0 1 0 1.06-1.06L7.06 15z"
            fill="currentColor"
          />
          <path
            d="M12.03 15.47a.75.75 0 1 0-1.06 1.06l.47.47-.47.47a.75.75 0 0 0 1.06 1.06l1-1c.3-.3.3-.77 0-1.06z"
            fill="currentColor"
          />
          <path
