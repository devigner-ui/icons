...
const IconAirbudsCaseCharge = forwardRef<SVGSVGElement, IconProps>(
  function IconAirbudsCaseCharge(
      ...
      <>
        {!fill ? (
          ...
          >
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M3.95 4.06C3 5.38 3 7.25 3 11v2c0 3.75 0 5.62.95 6.94a5 5 0 0 0 1.11 1.1C6.38 22 8.25 22 12 22s5.62 0 6.94-.95a5 5 0 0 0 1.1-1.11C21 18.62 21 16.75 21 13v-2c0-3.75 0-5.62-.95-6.94a5 5 0 0 0-1.11-1.1C17.62 2 15.75 2 12 2s-5.62 0-6.94.95a5 5 0 0 0-1.1 1.11"
              fill="currentColor"
            />
            <path
            ...
            />
            <path
              d="M12.59 13.47a.75.75 0 0 0-1.18-.94l-2 2.5a.75.75 0 0 0 .59 1.22h2.44l-1.03 1.28a.75.75 0 1 0 1.18.94l2-2.5a.75.75 0 0 0-.59-1.22h-2.44z"
              fill="currentColor"
            />
          </svg>
        ) : (
