...
const IconDropper2 = forwardRef<SVGSVGElement, IconProps>(function IconDropper2(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M18 12.92c0 1.15-.9 2.08-2 2.08s-2-.93-2-2.08c0-.72.78-1.68 1.37-2.3a.86.86 0 0 1 1.26 0c.59.62 1.37 1.58 1.37 2.3"
            stroke="currentColor"
            strokeWidth={strokeWidth}
          />
          <path
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M22 9.25h-3a.75.75 0 0 0 0 1.5h3v1.5h-2a.75.75 0 0 0 0 1.5h2v2.76c0 .65-.28 1.28-.76 1.72a7.8 7.8 0 0 1-10.48 0 2.3 2.3 0 0 1-.76-1.72V10c0-1.89 0-2.83.59-3.41C11.17 6 12.1 6 14 6h4c1.89 0 2.83 0 3.41.59.5.5.58 1.26.59 2.66m-4 3.67c0 1.15-.9 2.08-2 2.08s-2-.93-2-2.08c0-.72.78-1.68 1.37-2.3a.86.86 0 0 1 1.26 0c.59.62 1.37 1.58 1.37 2.3"
            fill="currentColor"
          />
          <path
            opacity={duotone ? "0.4" : "1"}
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M22 12.25v-1.5h-3a.75.75 0 1 1 0-1.5h3c-.01-1.4-.08-2.16-.59-2.66C20.83 6 19.9 6 18 6h-4c-1.89 0-2.83 0-3.41.59C10 7.17 10 8.1 10 10v6.5c0 .66.28 1.3.76 1.73a7.8 7.8 0 0 0 4.49 2v1.02a.75.75 0 1 0 1.5 0v-1.03a7.8 7.8 0 0 0 4.49-1.99c.48-.44.76-1.07.76-1.72v-2.76h-2a.75.75 0 1 1 0-1.5zM16 15c1.1 0 2-.93 2-2.08 0-.72-.78-1.68-1.37-2.3a.86.86 0 0 0-1.26 0c-.59.62-1.37 1.58-1.37 2.3 0 1.15.9 2.08 2 2.08"
            fill="currentColor"
          />
        </svg>
      )}
