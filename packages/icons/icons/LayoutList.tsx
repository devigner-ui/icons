...
const IconLayoutList = forwardRef<SVGSVGElement, IconProps>(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M21.67 16.25h-6a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75"
              fill="currentColor"
            />
            <path
              d="M21.67 20.25h-6a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
