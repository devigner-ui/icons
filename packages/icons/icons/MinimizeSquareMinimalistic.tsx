...
const IconMinimizeSquareMinimalistic = forwardRef<SVGSVGElement, IconProps>(
  function IconMinimizeSquareMinimalistic(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M6.47 17.53a.75.75 0 0 1 0-1.06l2.22-2.22H7.5a.75.75 0 0 1 0-1.5h3c.41 0 .75.34.75.75v3a.75.75 0 0 1-1.5 0v-1.19l-2.22 2.22c-.3.3-.77.3-1.06 0"
              fill="currentColor"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M17.25 10.5c0 .41-.34.75-.75.75h-3a.75.75 0 0 1-.75-.75v-3a.75.75 0 0 1 1.5 0v1.19l2.22-2.22a.75.75 0 1 1 1.06 1.06l-2.22 2.22h1.19c.41 0 .75.34.75.75"
              fill="currentColor"
            />
          </svg>
        ) : (
...
export default IconMinimizeSquareMinimalistic;
