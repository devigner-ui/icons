...
const IconCloudFile = forwardRef<SVGSVGElement, IconProps>(
  function IconCloudFile(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M10.33 14.57a2.2 2.2 0 0 1 1.32 0m-3.86.8-.29-.02c-.83 0-1.5.6-1.5 1.33S6.67 18 7.5 18H11c1.1 0 2-.79 2-1.76 0-.78-.56-1.43-1.35-1.67m-3.86.8q-.12-.28-.12-.6c0-.98.9-1.77 2-1.77 1.03 0 1.87.69 1.98 1.57m-3.86.8q.3.06.54.2"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeLinecap="round"
            />
          ...
          >
            ...
            />
            <path
              d="M13 16.24c0 .97-.9 1.76-2 1.76H7.5c-.83 0-1.5-.6-1.5-1.32s.67-1.33 1.5-1.33l.3.03q-.13-.3-.13-.62c0-.97.9-1.76 2-1.76 1.03 0 1.87.69 1.98 1.57.79.24 1.35.9 1.35 1.67"
              fill="currentColor"
            />
            <path
