...
const IconCallCalling = forwardRef<SVGSVGElement, IconProps>(
  function IconCallCalling(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              ...
              d="M19.17 9c0-.6-.47-1.52-1.17-2.27-.64-.69-1.49-1.23-2.33-1.23"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeLinecap="round"
          ...
          >
            <path
              d="M18.29 10.75a.77.77 0 0 1-.77-.77c0-.37-.37-1.14-.99-1.81-.61-.65-1.28-1.03-1.84-1.03a.77.77 0 0 1 0-1.54c1 0 2.05.54 2.97 1.51.86.91 1.41 2.04 1.41 2.86 0 .43-.35.78-.78.78"
              fill="currentColor"
            />
            <path
              d="M21.9 10.75a.77.77 0 0 1-.77-.77 6.44 6.44 0 0 0-6.43-6.43.78.78 0 0 1-.01-1.55c4.4 0 7.98 3.58 7.98 7.98 0 .42-.35.77-.77.77"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
...
export default IconCallCalling;
