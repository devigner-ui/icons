...
const IconCardAdd = forwardRef<SVGSVGElement, IconProps>(function IconCardAdd(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M20.64 2H17.7c-1.27 0-2.03.76-2.03 2.03v2.94c0 1.27.76 2.03 2.03 2.03h2.94c1.27 0 2.03-.76 2.03-2.03V4.03c0-1.27-.76-2.03-2.03-2.03m.94 3.93q-.16.16-.4.18h-1.42l.01 1.39a.6.6 0 0 1-.19.43q-.16.16-.4.17a.6.6 0 0 1-.6-.6V6.1l-1.4.01a.6.6 0 0 1-.6-.61c0-.33.26-.6.6-.6l1.4.01v-1.4a.6.6 0 0 1 .6-.61c.32 0 .6.28.6.61l-.02 1.39h1.41c.33 0 .6.27.6.6a.7.7 0 0 1-.19.43"
            fill="currentColor"
          />
        </svg>
      )}
