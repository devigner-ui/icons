...
const IconWalletMinus = forwardRef<SVGSVGElement, IconProps>(
  function IconWalletMinus(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            <path
              fill="currentColor"
              d="M14.5 16.75h-5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h5c.41 0 .75.34.75.75s-.34.75-.75.75"
            />
          </svg>
        ) : (
          <svg
          ...
          >
            ...
            />
            <path
              d="M18.96 9.52q-.68-.2-1.4-.2H7.78q-1.02 0-1.92.39A4.9 4.9 0 0 0 2.9 14.2v1.95q0 .35.05.71.33 4.77 5.1 5.09.34.05.71.05h7.8q5.55 0 5.84-5.26l.02-.59V14.2a4.9 4.9 0 0 0-3.47-4.68m-3.79 7.23h-5a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h5c.41 0 .75.34.75.75s-.34.75-.75.75"
              fill="currentColor"
            />
          </svg>
        )}
