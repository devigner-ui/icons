...
const IconShieldKeyhole = forwardRef<SVGSVGElement, IconProps>(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M11.5 16h1a1 1 0 0 0 1-1v-1.4a3 3 0 1 0-3 0V15a1 1 0 0 0 1 1"
              stroke="currentColor"
              strokeWidth={strokeWidth}
          ...
          >
            ...
            />
            <path
              d="M13.5 15a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1.4a3 3 0 1 1 3 0z"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M3.38 5.08C3 5.62 3 7.22 3 10.42v1.57c0 5.64 4.24 8.38 6.9 9.54.72.31 1.08.47 2.1.47s1.38-.16 2.1-.47c2.66-1.16 6.9-3.9 6.9-9.54v-1.57c0-3.2 0-4.8-.38-5.34-.37-.53-1.88-1.05-4.88-2.08l-.58-.2C13.6 2.28 12.81 2 12 2s-1.6.27-3.16.8l-.58.2c-3 1.03-4.5 1.55-4.88 2.08M13.5 15a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1.4a3 3 0 1 1 3 0z"
              fill="currentColor"
            />
          </svg>
        )}
