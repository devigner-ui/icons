...
const IconFolderCheck = forwardRef<SVGSVGElement, IconProps>(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M14.5 11.44c.3.27.34.75.06 1.06l-2.67 3a.75.75 0 0 1-1.12 0L9.44 14a.75.75 0 1 1 1.12-1l.77.87 2.11-2.37a.75.75 0 0 1 1.06-.06"
              fill="currentColor"
            />
          </svg>
        ) : (
