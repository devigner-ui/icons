...
const IconSaleSquare = forwardRef<SVGSVGElement, IconProps>(
  function IconSaleSquare(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M15.53 8.47c.3.3.3.77 0 1.06l-6 6a.75.75 0 0 1-1.06-1.06l6-6c.3-.3.77-.3 1.06 0"
              fill="currentColor"
            />
            <path
              d="M14.5 15.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2"
              fill="currentColor"
            />
            <path
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M3.46 3.46C2 4.93 2 7.3 2 12s0 7.07 1.46 8.54C4.93 22 7.3 22 12 22s7.07 0 8.54-1.46C22 19.07 22 16.7 22 12s0-7.07-1.46-8.54C19.07 2 16.7 2 12 2S4.93 2 3.46 3.46m12.07 5.01c.3.3.3.77 0 1.06l-6 6a.75.75 0 0 1-1.06-1.06l6-6c.3-.3.77-.3 1.06 0M10.5 9.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0m4 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2"
              fill="currentColor"
            />
          </svg>
        )}
