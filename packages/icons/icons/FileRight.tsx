...
const IconFileRight = forwardRef<SVGSVGElement, IconProps>(
  function IconFileRight(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            <path
              opacity={duotone ? "0.4" : "1"}
              d="M6 16h5m0 0-1.87-2M11 16l-1.87 2"
              stroke="currentColor"
              strokeWidth={strokeWidth}
              strokeLinecap="round"
          ...
          >
            ...
            />
            <path
              d="M11.55 15.49c.27.29.27.73 0 1.02l-1.88 2a.75.75 0 1 1-1.1-1.02l.7-.74H6a.75.75 0 1 1 0-1.5h3.27l-.7-.74a.75.75 0 1 1 1.1-1.02z"
              fill="currentColor"
            />
            <path
