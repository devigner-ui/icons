...
const IconPenClose = forwardRef<SVGSVGElement, IconProps>(function IconPenClose(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M7.17 2c-1.06 0-2.04.37-2.81.99a4.45 4.45 0 0 0-1.04 5.83A4.5 4.5 0 0 0 7.17 11a4.4 4.4 0 0 0 3.85-2.18 4.5 4.5 0 0 0 .65-2.32A4.5 4.5 0 0 0 7.17 2M8.9 8.21a.7.7 0 0 1-.53.22.7.7 0 0 1-.53-.22l-.66-.66-.69.69a.7.7 0 0 1-.53.22.7.7 0 0 1-.53-.22.75.75 0 0 1 0-1.06l.69-.69-.66-.66a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.66.66.63-.63a.75.75 0 0 1 1.06 0c.29.29.29.77 0 1.06l-.63.63.66.66c.3.29.3.76 0 1.06"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          ...
          />
          <path
            d="M7.17 2c-1.06 0-2.04.37-2.81.99a4.45 4.45 0 0 0-1.04 5.83A4.5 4.5 0 0 0 7.17 11a4.4 4.4 0 0 0 3.85-2.18 4.5 4.5 0 0 0 .65-2.32A4.5 4.5 0 0 0 7.17 2M8.9 8.21a.8.8 0 0 1-.53.22.8.8 0 0 1-.53-.22l-.66-.66-.68.68a.7.7 0 0 1-.53.22.7.7 0 0 1-.53-.22.75.75 0 0 1 0-1.06l.69-.69-.67-.65a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.66.66.63-.63a.75.75 0 0 1 1.06 0c.29.29.29.77 0 1.06l-.63.63.66.66c.3.29.3.76 0 1.06"
            fill="currentColor"
          />
          <path
