...
const IconCalendarMinimalistic = forwardRef<SVGSVGElement, IconProps>(
  function IconCalendarMinimalistic(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M22 14v-2l-.01-2.25H2V14c0 3.77 0 5.66 1.17 6.83S6.23 22 10 22h4c3.77 0 5.66 0 6.83-1.17S22 17.77 22 14"
              fill="currentColor"
            />
            <path
...
export default IconCalendarMinimalistic;
