...
const IconCartLargeMinimalistic = forwardRef<SVGSVGElement, IconProps>(
  function IconCartLargeMinimalistic(
        ...
        {!fill ? (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M3.04 2.3a.75.75 0 0 0-.5 1.4l.26.1c.67.23 1.11.39 1.43.55.3.15.44.27.53.4s.16.31.2.67C5 5.8 5 6.3 5 7.04v2.6h15.72c.33-1.66.49-2.5.06-3.06C20.33 6 18.82 6 17.13 6H6.5q0-.4-.04-.74c-.05-.5-.17-.95-.45-1.36A3 3 0 0 0 4.9 3q-.63-.29-1.56-.6z"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
              d="m20.2 12.19.5-2.43.02-.12H5c0 2.94.06 3.91.93 4.83s2.26.91 5.05.91h5.3c1.56 0 2.34 0 2.9-.45.55-.45.7-1.21 1.02-2.74"
              fill="currentColor"
            />
            <path
              d="M7.5 18a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3"
