...
const IconClipboardClose = forwardRef<SVGSVGElement, IconProps>(
  function IconClipboardClose(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="m15.2 15.62-1.45-1.45 1.4-1.4a.75.75 0 0 0 0-1.06.75.75 0 0 0-1.06 0l-1.4 1.4-1.45-1.45a.75.75 0 0 0-1.06 0 .75.75 0 0 0 0 1.06l1.45 1.45-1.49 1.49a.75.75 0 0 0 0 1.06q.23.22.53.22t.53-.22l1.49-1.49 1.45 1.45q.23.22.53.22t.53-.22a.75.75 0 0 0 0-1.06"
              fill="currentColor"
            />
          </svg>
        ) : (
