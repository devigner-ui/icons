...
const IconFigmaFile = forwardRef<SVGSVGElement, IconProps>(
  function IconFigmaFile(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              ...
              fillRule="evenodd"
              clipRule="evenodd"
              d="M4.25 11.5c0-1.24 1-2.25 2.25-2.25h3A2.25 2.25 0 0 1 11.18 13a2.25 2.25 0 0 1-2.43 3.62v.88A2.25 2.25 0 1 1 4.82 16a2.24 2.24 0 0 1 0-3c-.35-.4-.57-.92-.57-1.5m3 3v.75H6.5a.75.75 0 1 1 0-1.5h.75zm1.5 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0m.75-2.25a.75.75 0 1 0 0-1.5h-.75v1.5zm-2.25 4.5H6.5a.75.75 0 1 0 .75.75zm-.75-6h.75v1.5H6.5a.75.75 0 1 1 0-1.5"
              fill="currentColor"
            />
          </svg>
        ) : duotone ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M6.38 11.5A1.4 1.4 0 0 0 5 12.92c0 .48.23.9.58 1.17-.35.26-.58.68-.58 1.16s.23.9.58 1.16c-.35.26-.58.69-.58 1.17 0 .78.62 1.42 1.38 1.42a1.4 1.4 0 0 0 1.37-1.42v-1.23q.37.31.87.32A1.4 1.4 0 0 0 10 15.25c0-.48-.23-.9-.58-1.16.35-.26.58-.69.58-1.17a1.4 1.4 0 0 0-1.38-1.42z"
              fill="currentColor"
            />
            <path
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M14 22h-4c-3.77 0-5.66 0-6.83-1.17S2 17.77 2 14v-4c0-3.77 0-5.66 1.17-6.83S6.24 2 10.03 2q.9 0 1.5.02l-.02.24-.01 2.84c0 1.1 0 2.06.1 2.84.12.85.38 1.7 1.07 2.39s1.54.95 2.39 1.07c.78.1 1.75.1 2.85.1h4.05q.05.78.04 2.06V14c0 3.77 0 5.66-1.17 6.83S17.77 22 14 22M4.25 11.5c0-1.24 1-2.25 2.25-2.25h3A2.25 2.25 0 0 1 11.18 13a2.25 2.25 0 0 1-2.43 3.62v.88A2.25 2.25 0 1 1 4.82 16a2.24 2.24 0 0 1 0-3c-.35-.4-.57-.92-.57-1.5m1.5 3c0-.41.34-.75.75-.75h.75v1.5H6.5a.75.75 0 0 1-.75-.75m1.5-2.25H6.5a.75.75 0 1 1 0-1.5h.75zm3-.75c0 .41-.34.75-.75.75h-.75v-1.5h.75c.41 0 .75.34.75.75m-1.5 3a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0M6.5 16.75h.75v.75a.75.75 0 1 1-.75-.75"
              fill="currentColor"
            />
          </svg>
        )}
