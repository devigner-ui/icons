...
const IconClipboardText = forwardRef<SVGSVGElement, IconProps>(
        ...
        {!fill ? (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M6.25 14.5c0-.41.34-.75.75-.75h8a.75.75 0 0 1 0 1.5H7a.75.75 0 0 1-.75-.75m0 3.5c0-.41.34-.75.75-.75h5.5a.75.75 0 0 1 0 1.5H7a.75.75 0 0 1-.75-.75"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M6.5 4.04c-1.26.07-2.05.27-2.62.84C3 5.76 3 7.17 3 10v6c0 2.83 0 4.24.88 5.12S6.18 22 9 22h6c2.83 0 4.24 0 5.12-.88S21 18.82 21 16v-6c0-2.83 0-4.24-.88-5.12-.57-.57-1.36-.77-2.62-.84v.46a3 3 0 0 1-3 3h-5a3 3 0 0 1-3-3zm.5 9.71a.75.75 0 0 0 0 1.5h8a.75.75 0 0 0 0-1.5zm0 3.5a.75.75 0 0 0 0 1.5h5.5a.75.75 0 0 0 0-1.5z"
              fill="currentColor"
            />
          </svg>
        )}
