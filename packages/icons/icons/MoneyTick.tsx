...
const IconMoneyTick = forwardRef<SVGSVGElement, IconProps>(
  function IconMoneyTick(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M5.67 14a4 4 0 1 0 0 8 4 4 0 0 0 0-8m1.97 3.67-2.13 1.97a.8.8 0 0 1-.51.2.7.7 0 0 1-.53-.22l-.99-.99a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.48.48 1.6-1.48a.76.76 0 0 1 1.06.04c.28.3.26.78-.04 1.06"
              fill="currentColor"
            />
          </svg>
        ) : (
          ...
          >
            ...
            />
            <path
              d="M5.67 14a4 4 0 1 0 0 8 4 4 0 0 0 0-8m1.97 3.67-2.13 1.97a1 1 0 0 1-.5.2.7.7 0 0 1-.54-.22l-.99-.99a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.48.48 1.6-1.48a.76.76 0 0 1 1.06.04c.28.3.26.78-.04 1.06"
              fill="currentColor"
            />
          </svg>
        )}
