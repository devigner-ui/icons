...
const IconInboxOut = forwardRef<SVGSVGElement, IconProps>(function IconInboxOut(
    ...
    <>
      {!fill ? (
        ...
        >
          ...
          />
          <path
            d="M12.53 5.97a.75.75 0 0 0-1.06 0l-3.3 3.3a.75.75 0 0 0 1.06 1.06l2.02-2.02v8.19a3 3 0 0 1-1.17-.18c-.4-.19-.69-.53-1.28-1.22l-.6-.7c-.6-.69-.89-1.03-1.28-1.22-.4-.18-.85-.18-1.76-.18H2c0 4.06.1 6.18 1.46 7.54C4.93 22 7.3 22 12 22s7.07 0 8.54-1.46c1.35-1.36 1.45-3.48 1.46-7.54h-3.16c-.9 0-1.36 0-1.76.18-.4.19-.69.53-1.28 1.22l-.6.7c-.6.7-.89 1.03-1.28 1.22-.3.14-.64.17-1.17.18V8.3l2.02 2.02a.75.75 0 1 0 1.06-1.06z"
            fill="currentColor"
          />
        </svg>
      ) : (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12 1.25q.31 0 .53.22l3 3a.75.75 0 0 1-1.06 1.06l-1.72-1.72V10a.75.75 0 1 1-1.5 0V3.81L9.53 5.53a.75.75 0 1 1-1.06-1.06l3-3a.8.8 0 0 1 .53-.22"
            fill="currentColor"
          />
          <path
          ...
          />
          <path
            d="M22 12c0-4.71 0-7.07-1.46-8.54-1.02-1.02-2.48-1.33-4.86-1.42l-.47-.01 1.38 1.38a2.25 2.25 0 0 1-2.34 3.71V10a2.25 2.25 0 1 1-4.5 0V7.12a2.25 2.25 0 0 1-2.34-3.71l1.38-1.38c-2.67.07-4.24.35-5.33 1.43C2 4.93 2 7.3 2 12v.25h3.3c.77 0 1.38 0 1.93.25.55.26.95.72 1.45 1.3l.7.82c.63.73.8.92 1.02 1.02s.47.11 1.44.11h.32c.97 0 1.23-.02 1.44-.11.22-.1.4-.29 1.03-1.02l.7-.81c.5-.59.89-1.05 1.44-1.3a5 5 0 0 1 1.94-.26H22z"
            fill="currentColor"
          />
        </svg>
      )}
