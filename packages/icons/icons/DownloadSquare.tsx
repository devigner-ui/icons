...
const IconDownloadSquare = forwardRef<SVGSVGElement, IconProps>(
  function IconDownloadSquare(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M12.75 7a.75.75 0 0 0-1.5 0v5.19l-1.72-1.72a.75.75 0 0 0-1.06 1.06l3 3a.75.75 0 0 0 1.06 0l3-3a.75.75 0 1 0-1.06-1.06l-1.72 1.72z"
              fill="currentColor"
            />
            <path
              d="M8 16.25a.75.75 0 0 0 0 1.5h8a.75.75 0 0 0 0-1.5z"
              fill="currentColor"
            />
          </svg>
        ) : (
