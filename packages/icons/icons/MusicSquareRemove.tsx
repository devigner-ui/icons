...
const IconMusicSquareRemove = forwardRef<SVGSVGElement, IconProps>(
  function IconMusicSquareRemove(
        ...
        {!fill ? (
          ...
          >
            ...
            <g opacity={duotone ? "0.4" : "1"}>
              ...
              />
              <path
                d="M14.14 12V6.34c0-1.21-.76-1.37-1.52-1.16l-2.89.79c-.52.14-.89.56-.89 1.16v5.84"
                stroke="currentColor"
                strokeWidth={strokeWidth}
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          >
            <path
              d="M22.64 16.33a4 4 0 1 0-5.94 5.34 4 4 0 0 0 5.94-5.34m-1.37 4.25a.7.7 0 0 1-.53.22.7.7 0 0 1-.53-.22l-.53-.53-.55.55a.7.7 0 0 1-.53.22.7.7 0 0 1-.53-.22.75.75 0 0 1 0-1.06l.55-.55-.53-.53a.75.75 0 0 1 0-1.06.75.75 0 0 1 1.06 0l.53.53.5-.5a.75.75 0 0 1 1.06 0c.29.29.29.77 0 1.06l-.5.5.53.53c.29.29.29.76 0 1.06"
              fill="currentColor"
            />
            <path
