...
const IconBag = forwardRef<SVGSVGElement, IconProps>(function IconBag(
      ...
      {!fill ? (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8.25 6.02V5a3.75 3.75 0 0 1 7.5 0v1.02c1.29.03 2.07.17 2.68.67.83.7 1.05 1.86 1.49 4.2l.75 4c.61 3.3.92 4.94.02 6.03S18.12 22 14.77 22H9.23c-3.35 0-5.02 0-5.92-1.08-.9-1.09-.6-2.73.02-6.03l.75-4c.44-2.34.66-3.5 1.5-4.2.6-.5 1.38-.64 2.67-.67M9.75 5a2.25 2.25 0 1 1 4.5 0v1h-4.5z"
            fill="currentColor"
          />
        </svg>
      )}
