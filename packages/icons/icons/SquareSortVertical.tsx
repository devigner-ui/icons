...
const IconSquareSortVertical = forwardRef<SVGSVGElement, IconProps>(
  function IconSquareSortVertical(
      ...
      <>
        {!fill ? (
          ...
          >
            ...
            />
            <path
              d="M12.56 11.25a.75.75 0 0 1-1.11-1l2.5-2.75a.75.75 0 0 1 1.1 0l2.5 2.75a.75.75 0 0 1-1.1 1l-1.2-1.31V16a.75.75 0 0 1-1.5 0V9.94z"
              fill="currentColor"
            />
            <path
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2 12c0-4.71 0-7.07 1.46-8.54C4.93 2 7.3 2 12 2s7.07 0 8.54 1.46C22 4.93 22 7.3 22 12s0 7.07-1.46 8.54C19.07 22 16.7 22 12 22s-7.07 0-8.54-1.46C2 19.07 2 16.7 2 12m5.55.75a.75.75 0 1 0-1.1 1l2.5 2.75a.75.75 0 0 0 1.1 0l2.5-2.75a.75.75 0 0 0-1.1-1l-1.2 1.31V8a.75.75 0 0 0-1.5 0v6.06zm3.95-1.45c.3.28.78.26 1.05-.05l1.2-1.31V16a.75.75 0 0 0 1.5 0V9.94l1.2 1.31a.75.75 0 0 0 1.1-1l-2.5-2.75a.75.75 0 0 0-1.1 0l-2.5 2.75c-.28.3-.26.78.05 1.05"
              fill="currentColor"
            />
          </svg>
        )}
