...
const IconVideoAdd = forwardRef<SVGSVGElement, IconProps>(function IconVideoAdd(
  ...
  return (
    <>
      {!fill ? (
        ...
        >
          <path
            d="M22.67 9v6q0 .34-.02.67l-.14-.17-.03-.04a4.5 4.5 0 0 0-7.16 5.36 4 4 0 0 0 .86 1.02l.16.14q-.32.02-.67.02h-6c-5 0-7-2-7-7V9c0-5 2-7 7-7h6c5 0 7 2 7 7"
            stroke="currentColor"
          ...
          <path
            d="M23.67 18.5q0 .54-.13 1.05-.17.68-.52 1.27a4.5 4.5 0 0 1-6.67 1.16h-.01l-.16-.14-.04-.03q-.49-.43-.82-.99a4.5 4.5 0 0 1 7.16-5.36l.03.04.14.17a4.4 4.4 0 0 1 1.02 2.83"
            stroke="currentColor"
            strokeWidth={strokeWidth}
            strokeMiterlimit="10"
            strokeLinecap="round"
