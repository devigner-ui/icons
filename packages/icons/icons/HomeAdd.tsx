...
const IconHomeAdd = forwardRef<SVGSVGElement, IconProps>(function IconHomeAdd(
      ...
      {!fill ? (
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M2.52 7.82C2 8.77 2 9.92 2 12.2v1.53c0 3.9 0 5.85 1.17 7.06S6.23 22 10 22h4c3.77 0 5.66 0 6.83-1.21S22 17.63 22 13.73V12.2c0-2.28 0-3.43-.52-4.38s-1.47-1.53-3.36-2.71l-2-1.24C14.12 2.62 13.1 2 12 2s-2.11.62-4.12 1.87l-2 1.24c-1.9 1.18-2.84 1.76-3.36 2.71M12.75 11a.75.75 0 0 0-1.5 0v2.25H9a.75.75 0 0 0 0 1.5h2.25V17a.75.75 0 0 0 1.5 0v-2.25H15a.75.75 0 0 0 0-1.5h-2.25z"
            fill="currentColor"
          />
        </svg>
      )}
