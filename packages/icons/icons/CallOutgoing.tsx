...
const IconCallOutgoing = forwardRef<SVGSVGElement, IconProps>(
    ...
    return (
      <>
        {!fill ? (
          ...
          >
            <path
              d="M20.67 9.55a.76.76 0 0 1-.75-.75V4.75h-4.05a.76.76 0 0 1-.75-.75c0-.41.34-.75.75-.75h4.8c.41 0 .75.34.75.75v4.8c0 .41-.34.75-.75.75"
              fill="currentColor"
            />
            <path
              opacity={duotone ? "0.4" : "1"}
