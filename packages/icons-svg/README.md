...
The artwork of [`@devigner-ui/icons`](https://www.npmjs.com/package/@devigner-ui/icons) as plain SVG files. 2,146 symbols in outline, twotone, bold and bulk: 8,584 drawings, no framework, no build step.
