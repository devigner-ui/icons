...
The artwork of [`@devigner-ui/icons`](https://www.npmjs.com/package/@devigner-ui/icons) as plain SVG files. 2,147 symbols in outline, twotone, bold and bulk: 8,588 drawings, no framework, no build step.
